 ...
 * and change the version with it — a response filed as "1.0" has to mean the
 * client was shown exactly this, or the record documents nothing.
 */
...
export const PURPOSE_PRIVACY_HELP =
  "Please do not provide sensitive personal information or information about other individuals unless necessary for your transaction.";
 ...
 */
export function PrivacyNoticeDialog({ openCount }) {
      ...
      <div className="privacy-dialog-inner">
        <div className="privacy-dialog-head">
          ...
          <button
            ...
            aria-label="Close the Privacy Notice"
            onClick={closeDialog}
          >
            <X size={18} />
          </button>
        ...
        <div className="privacy-dialog-body">
          <p>
            The Commission on Higher Education (CHED), through the Office of
            Student Development and Services (OSDS), respects your right to
            privacy and is committed to protecting your personal information in
            accordance with Republic Act No. 10173, or the Data Privacy Act of
            2012, its Implementing Rules and Regulations, and other applicable
            issuances.
          </p>

          <h3>Information We Collect</h3>
          <p>
            For purposes of documenting your visit and processing your
            Certificate of Appearance, CHED-OSDS may collect the following
            information:
          </p>
          <ul>
            <li>Title</li>
            ...
            <li>
              Other information you voluntarily provide in connection with your
              transaction
            </li>
          </ul>
          <p>
            Please avoid providing sensitive personal information or information
            about other individuals unless it is necessary for your transaction.
          </p>

          <h3>Purpose of Processing</h3>
          <p>
            Your information will be collected and processed only for legitimate
            and official purposes, including:
          </p>
          <ul>
            <li>documenting your visit or transaction with CHED-OSDS;</li>
            <li>processing and issuing your Certificate of Appearance;</li>
            <li>
              verifying the authenticity of certificates issued through the
              system;
            </li>
          ...
          <p>
            Your information will not be used for purposes incompatible with
            those stated above unless required or permitted by law.
          </p>
          ...
          <p>
            ...
            processing activity, appropriate consent will be obtained
            separately.
          </p>
          ...
          <p>
            ...
            personnel and service providers, when applicable, who require access
            for legitimate official purposes.
          </p>
          <p>
          ...
          <p>
            ...
            to fulfill the purposes for which it was collected and in accordance
            with applicable CHED records-retention policies, government
          ...
          <h3>Your Rights</h3>
          <p>
            Subject to applicable laws and regulations, you may exercise your
            rights as a data subject, including the right to:
          </p>
          <ul>
            <li>
            ...
            <li>
              obtain appropriate remedies in case of violations of your data
              privacy rights; and
            </li>
            <li>lodge a complaint with the National Privacy Commission.</li>
          </ul>
          <p>
            Some requests may be subject to limitations when CHED is required by
            law or government records-management rules to retain or process
            particular records.
          </p>

          <h3>Contact Information</h3>
          <p>
            For questions, concerns, or requests regarding the processing of
            your personal information, you may contact:
          </p>
          <address>
